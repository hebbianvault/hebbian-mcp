...
Python sibling of `@hebbianvault/mcp`. Connect Claude Code, Codex, Gemini CLI, Claude Desktop, Cowork, Cursor, or any MCP-compatible agent to your Hebbian workspace with the same 9 tools and the same configuration. A thin client; all intelligence and access control live in the Hebbian service.
